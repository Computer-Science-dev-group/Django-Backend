        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "esp",
                    models.CharField(
                        choices=[(0, "SendInBlue")], default=0, max_length=100
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            (0, "Pending: Email has been sent to the esp"),
                            (1, "Sent: Email has been sent by the esp"),
                            (3, "Success: Email has been delivered to the user"),
                            (4, "Failed: Emails was not delivered or an error occured"),
                        ],
                        default=0,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="notification.emailmessagemodel",
                    ),
                ),
            ],
            options={
